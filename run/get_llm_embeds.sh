...
#SBATCH --job-name=get_llm_embeds # Job name                                       
...
#SBATCH -e get_llm_embeds.err # Error file for this job.                              
#SBATCH -o get_llm_embeds.out # Output file for this job.                             
